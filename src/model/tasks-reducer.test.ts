...
test('correct task should change its title', () => {
  const newTaskTitle =
    tasksReducer(
      startState,
      changeTaskTitleAC({id: 'todolistId1', taskID: '2', title: 'New task'}))

  expect(newTaskTitle.todolistId1[1].title).toBe('New task')
  expect(newTaskTitle.todolistId1[1].id).toBe('2')
